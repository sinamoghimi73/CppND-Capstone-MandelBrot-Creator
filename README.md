...
For which initial values <img src="https://render.githubusercontent.com/render/math?math=z_{0}"> does the sequence <img src="https://render.githubusercontent.com/render/math?math=z_{k} , k \ge 0">
